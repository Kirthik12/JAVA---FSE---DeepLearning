...
public class AppMenu {
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1:
                    Search.displayAllProducts(products);
                    break;

                case 2:
                    System.out.print("Enter product name: ");
                    String name = scanner.nextLine();
                    Product byName = Search.linearSearchByName(products, name);
                ...
                case 3:
                    ...
                    Product byId = Search.linearSearchById(products, id);
                ...
                case 4:
                    ...
                    Product[] byCategory = Search.linearSearchByCategory(products, category);
                ...
                case 5:
                    ...
                    Search.sortByName(products);  // Ensure sorted
                    Product binaryResult = Search.binarySearchByName(products, binaryName);
